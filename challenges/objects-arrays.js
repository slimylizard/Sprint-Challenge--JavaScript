...
zooAnimals.forEach (function(object){
  let display = `Name: ${object.animal_name}, Scientific: ${object.scientific_name}`;
...
lowerPopulation = zooAnimals.filter (function(object){
  let lowPop = object.population;
  return lowPop < 5; 
})
